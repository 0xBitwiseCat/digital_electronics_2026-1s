module top (
    ...
    present_80_core u_core (
        ...
        .key_in({rx_buf[8],rx_buf[9],rx_buf[10],rx_buf[11],rx_buf[12],
    ...
    // ---- LEDs de diagnostico MEJORADO: muestra progreso de recepcion ----
    ...
    assign led_recv_done   = latch_first_byte;  // D3: al menos 1 byte llego
    assign led_crypto_done = latch_mid;         // D4: llego a mitad de camino (9 bytes)
    assign led_send_done   = latch_recv;        // D5: recibio los 19 bytes completos
